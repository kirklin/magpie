...
export const STRINGS = {
  zh: {
    ...
    "settings.shortcut_desktop_desc": "由系统管理，可在系统设置中修改",
    "settings.shortcut_unassigned": "未设置",
    "settings.shortcut_change": "修改…",
    "settings.shortcut_manual_desc": "这个桌面环境不允许应用自己注册全局快捷键。请在系统的键盘设置里添加一个自定义快捷键，命令填写：",
    "settings.shortcut_portal_unassigned_desc": "系统还没有为它分配按键。也可以在系统的键盘设置里添加一个自定义快捷键，命令填写：",
    "settings.command_copied": "命令已复制",
    "settings.export": "导出",
  ...
  en: {
    ...
    "settings.tray_icon": "Show tray icon",
    ...
    "settings.shortcut_desktop_desc": "Managed by the desktop; change it in the system settings",
    "settings.shortcut_unassigned": "Not set",
    "settings.shortcut_change": "Change…",
    "settings.shortcut_manual_desc": "This desktop doesn't let apps register global shortcuts. Add a custom shortcut in the system keyboard settings that runs:",
    "settings.shortcut_portal_unassigned_desc": "The desktop hasn't assigned it a key yet. You can also add a custom shortcut in the system keyboard settings that runs:",
    "settings.command_copied": "Command copied",
    ...
    "action.copy_and_hide": "Copy and Hide Window",
